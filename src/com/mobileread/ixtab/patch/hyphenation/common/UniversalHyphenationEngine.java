...
public abstract class UniversalHyphenationEngine implements HyphenationEngine {
	...
	private static final UniversalHyphenationEngine instance = Factories.INSTANCE.newHyphenationEngine();
	...
	public synchronized Hyphenation hyphenate(String s) {
		Hyphenation h = Factories.INSTANCE.newHyphenation(s);
	...
	protected abstract String fromLCID(int id);
