...
public final class MessageLocalization {
	...
	public static String getComposedMessage(String string, String tag) {
		return string;
	}

	public static String getComposedMessage(String string, String s,
			String valueOf, String valueOf2) {
		return string;
	}
}
