...
public class DevCertInjectPatch extends Patch {
	...
	protected void initLocalization(String locale, Map map) {
		if (RESOURCE_ID_ENGLISH.equals(locale)) {
			...
			map.put(I18N_JBPATCH_DESCRIPTION, "Kindlets must be signed with a developer certificate. This patch will automatically install a set of known certificates used by mobileread developers (Version: 20120712), if required");
