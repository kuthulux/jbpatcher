...
interface MarginsPatchKeys {
	...
	final String DEFAULT_READER_CONTENT_LEFT_MARGIN = "40";
	final String DEFAULT_READER_CONTENT_TOP_MARGIN = "30";
	final String DEFAULT_READER_CONTENT_TOP_MARGIN_OFFSET = "10";
	final String DEFAULT_READER_CONTENT_RIGHT_MARGIN = "40";
	final String DEFAULT_READER_PROGRESSBAR_FOOTER_HEIGHT = "30";
	final String DEFAULT_FONT_WORDSPERLINE_MARGIN_LIST_FEWEST = "120";
	final String DEFAULT_FONT_WORDSPERLINE_MARGIN_LIST_FEWER = "80";
	final String DEFAULT_FONT_WORDSPERLINE_MARGIN_LIST_DEFAULT = "40";
